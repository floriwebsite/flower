...
<div >
  ...
  <div><input type="text" name="type" value="0" style="display:none;" /></div>
  ...
  <div class="form-group">
    ...
    <div class="field field-icon-right">
      ...
      <input type="password" class="input radius-rounded" id="password" name="password" size="50" data-validate="required:必填,compare#>20:请正确输入密码" placeholder="请输入密码" />
    </div>
  </div>
